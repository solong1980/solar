...
public class DevRunningAnimationPanel extends JPanel implements Observer, Runnable {
	...
	public void drawWithGif() {
		Image solar_panel = ButtonUI.createGifImage("solar/60/solar_panel_good.gif");

		BufferedImage arrow1 = ButtonUI.createImageBuff("solar/60/arrowright.png");

		Image sewage_controller = ButtonUI.createGifImage("solar/60/solar_sewage_controller.gif");
		Image battery_pack = ButtonUI.createGifImage("solar/60/battery_pack.gif");

		BufferedImage arrow2 = ButtonUI.createImageBuff("solar/60/arrowright.png");

		Image fan = ButtonUI.createGifImage("solar/60/fan_good.gif");
		Image fanbad = ButtonUI.createGifImage("solar/60/fan_bad.gif");

		Image bakfan = ButtonUI.createGifImage("solar/60/bakfan_good.gif");
		Image bakfanbad = ButtonUI.createGifImage("solar/60/bakfan_bad.gif");

		Image waterpump = ButtonUI.createGifImage("solar/60/waterpump_good.gif");
		Image waterpumpbad = ButtonUI.createGifImage("solar/60/waterpump_bad.gif");

		Image bakwaterpump = ButtonUI.createGifImage("solar/60/bakwaterpump_good.gif");
		Image bakwaterpumpbad = ButtonUI.createGifImage("solar/60/bakwaterpump_bad.gif");
